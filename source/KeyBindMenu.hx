	...
	override function update(elapsed:Float)
	{
        ...
        switch(state){
            ...
            case "select":
                ...
                else if(#if android FlxG.android.justReleased.BACK || #end FlxG.keys.justPressed.ESCAPE #if android || FlxG.android.justPressed.BACK || FlxG.android.justReleased.BACK #end){
                    quit();
                }
